...
- Override manual (pilih kamar spesifik per mahasiswa)
...
- CRUD fasilitas umum (nama, kategori, kondisi, lokasi)
...
> Catatan navigasi: dengan sebanyak ini, sidebar admin sebaiknya dikelompokkan ke beberapa section (mis. **Operasional** = checkin, penempatan, pemetaan; **Aset & Fasilitas** = gedung/kamar, aset; **Pengajuan** = bebas asrama, izin pulang; **Keuangan**; **Lainnya** = kegiatan, penilaian teknisi, akun) — jangan taruh 12 menu datar sejajar, itu salah satu penyebab dashboard admin terasa berantakan.
