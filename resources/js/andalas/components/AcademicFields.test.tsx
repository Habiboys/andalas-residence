...
it('shows only departments and program levels belonging to the selected faculty and department', () => {
    const html = renderToStaticMarkup(<AcademicFields
        fakultas={[{ id: 'fti', name: 'Teknologi Informasi' }, { id: 'law', name: 'Hukum' }]}
        departemen={[{ id: 'inf', name: 'Informatika', faculty_id: 'fti' }, { id: 'law-dept', name: 'Departemen Hukum', faculty_id: 'law' }]}
        prodi={[{ id: 's1', name: 'Informatika', jenjang: 'S1', departemen_id: 'inf' }, { id: 's2', name: 'Informatika', jenjang: 'S2', departemen_id: 'inf' }, { id: 'law-prodi', name: 'Prodi Hukum', jenjang: 'S1', departemen_id: 'law-dept' }]}
        value={{ faculty_id: 'fti', departemen_id: 'inf', prodi_id: 's1' }} onChange={() => {}} />);
...
it('waits for a parent selection before offering departments and programs', () => {
    const html = renderToStaticMarkup(<AcademicFields value={{ faculty_id: '', departemen_id: '', prodi_id: '' }} onChange={() => {}} />);
